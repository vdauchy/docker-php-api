...
class Port implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Port';
     ...
     * Sets ip
     *
     * @param string $ip Host IP address that the container's port is mapped to
     *
     * @return $this
     */
     ...
     * Sets public_port
     *
     * @param int $public_port Port exposed on the host
     *
     * @return $this
     */
