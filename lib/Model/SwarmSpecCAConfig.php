...
class SwarmSpecCAConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'external_cas' => '\OpenAPI\Client\Model\SwarmSpecCAConfigExternalCAs[]',
    ...
    {
        $this->container['node_cert_expiry'] = $data['node_cert_expiry'] ?? null;
        $this->container['external_cas'] = $data['external_cas'] ?? null;
        $this->container['signing_ca_cert'] = $data['signing_ca_cert'] ?? null;
        $this->container['signing_ca_key'] = $data['signing_ca_key'] ?? null;
        $this->container['force_rotate'] = $data['force_rotate'] ?? null;
    }
     ...
     * Gets external_cas
     *
     * @return \OpenAPI\Client\Model\SwarmSpecCAConfigExternalCAs[]|null
     */
     ...
     * Sets external_cas
     *
     * @param \OpenAPI\Client\Model\SwarmSpecCAConfigExternalCAs[]|null $external_cas Configuration for forwarding signing requests to an external certificate authority.
     *
     * @return self
     */
