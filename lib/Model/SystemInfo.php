...
class SystemInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'default_address_pools' => '\OpenAPI\Client\Model\SystemInfoDefaultAddressPools[]',
        'warnings' => 'string[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['containers_running'] = $data['containers_running'] ?? null;
        $this->container['containers_paused'] = $data['containers_paused'] ?? null;
        $this->container['containers_stopped'] = $data['containers_stopped'] ?? null;
        $this->container['images'] = $data['images'] ?? null;
        $this->container['driver'] = $data['driver'] ?? null;
        $this->container['driver_status'] = $data['driver_status'] ?? null;
        $this->container['docker_root_dir'] = $data['docker_root_dir'] ?? null;
        $this->container['plugins'] = $data['plugins'] ?? null;
        $this->container['memory_limit'] = $data['memory_limit'] ?? null;
        $this->container['swap_limit'] = $data['swap_limit'] ?? null;
        $this->container['kernel_memory'] = $data['kernel_memory'] ?? null;
        $this->container['cpu_cfs_period'] = $data['cpu_cfs_period'] ?? null;
        $this->container['cpu_cfs_quota'] = $data['cpu_cfs_quota'] ?? null;
        $this->container['cpu_shares'] = $data['cpu_shares'] ?? null;
        $this->container['cpu_set'] = $data['cpu_set'] ?? null;
        $this->container['pids_limit'] = $data['pids_limit'] ?? null;
        $this->container['oom_kill_disable'] = $data['oom_kill_disable'] ?? null;
        $this->container['ipv4_forwarding'] = $data['ipv4_forwarding'] ?? null;
        $this->container['bridge_nf_iptables'] = $data['bridge_nf_iptables'] ?? null;
        $this->container['bridge_nf_ip6tables'] = $data['bridge_nf_ip6tables'] ?? null;
        $this->container['debug'] = $data['debug'] ?? null;
        $this->container['nfd'] = $data['nfd'] ?? null;
        $this->container['n_goroutines'] = $data['n_goroutines'] ?? null;
        $this->container['system_time'] = $data['system_time'] ?? null;
        $this->container['logging_driver'] = $data['logging_driver'] ?? null;
        $this->container['cgroup_driver'] = $data['cgroup_driver'] ?? 'cgroupfs';
        $this->container['cgroup_version'] = $data['cgroup_version'] ?? '1';
        $this->container['n_events_listener'] = $data['n_events_listener'] ?? null;
        ...
        $this->container['ncpu'] = $data['ncpu'] ?? null;
        $this->container['mem_total'] = $data['mem_total'] ?? null;
        $this->container['index_server_address'] = $data['index_server_address'] ?? 'https://index.docker.io/v1/';
        $this->container['registry_config'] = $data['registry_config'] ?? null;
        $this->container['generic_resources'] = $data['generic_resources'] ?? null;
        $this->container['http_proxy'] = $data['http_proxy'] ?? null;
        $this->container['https_proxy'] = $data['https_proxy'] ?? null;
        $this->container['no_proxy'] = $data['no_proxy'] ?? null;
        $this->container['name'] = $data['name'] ?? null;
        $this->container['labels'] = $data['labels'] ?? null;
        $this->container['experimental_build'] = $data['experimental_build'] ?? null;
        $this->container['server_version'] = $data['server_version'] ?? null;
        $this->container['cluster_store'] = $data['cluster_store'] ?? null;
        $this->container['cluster_advertise'] = $data['cluster_advertise'] ?? null;
        $this->container['runtimes'] = $data['runtimes'] ?? null;
        $this->container['default_runtime'] = $data['default_runtime'] ?? 'runc';
        $this->container['swarm'] = $data['swarm'] ?? null;
        $this->container['live_restore_enabled'] = $data['live_restore_enabled'] ?? false;
        $this->container['isolation'] = $data['isolation'] ?? 'default';
        $this->container['init_binary'] = $data['init_binary'] ?? null;
        $this->container['containerd_commit'] = $data['containerd_commit'] ?? null;
        $this->container['runc_commit'] = $data['runc_commit'] ?? null;
        $this->container['init_commit'] = $data['init_commit'] ?? null;
        $this->container['security_options'] = $data['security_options'] ?? null;
        $this->container['product_license'] = $data['product_license'] ?? null;
        $this->container['default_address_pools'] = $data['default_address_pools'] ?? null;
     ...
     * Sets kernel_memory
     *
     * @param bool|null $kernel_memory Indicates if the host has kernel memory limit support enabled.  <p><br /></p>  > **Deprecated**: This field is deprecated as the kernel 5.4 deprecated > `kmem.limit_in_bytes`.
     *
     * @return self
     */
     ...
     * Sets os_type
     *
     * @param string|null $os_type Generic type of the operating system of the host, as returned by the Go runtime (`GOOS`).  Currently returned values are \"linux\" and \"windows\". A full list of possible values can be found in the [Go documentation](https://golang.org/doc/install/source#environment).
     *
     * @return self
     */
     ...
     *
     * @param object[]|null $generic_resources User-defined resources can be either Integer resources (e.g, `SSD=3`) or String resources (e.g, `GPU=UUID1`).
     *
     * @return self
     */
     ...
     * Sets server_version
     *
     * @param string|null $server_version Version string of the daemon.  > **Note**: the [standalone Swarm API](/swarm/swarm-api/) > returns the Swarm version instead of the daemon  version, for example > `swarm/1.2.8`.
     *
     * @return self
     */
     ...
     *
     * @param string|null $cluster_advertise The network endpoint that the Engine advertises for the purpose of node discovery. ClusterAdvertise is a `host:port` combination on which the daemon is reachable by other hosts.  <p><br /></p>  > **Deprecated**: This field is only propagated when using standalone Swarm > mode, and overlay networking using an external k/v store. Overlay > networks with Swarm mode enabled use the built-in raft store, and > this field will be empty.
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $security_options List of security features that are enabled on the daemon, such as apparmor, seccomp, SELinux, user-namespaces (userns), and rootless.  Additional configuration options for each security feature may be present, and are included as a comma-separated list of key/value pairs.
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\SystemInfoDefaultAddressPools[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\SystemInfoDefaultAddressPools[]|null $default_address_pools List of custom default address pools for local networks, which can be specified in the daemon.json file or dockerd option.  Example: a Base \"10.10.0.0/16\" with Size 24 will define the set of 256 10.10.[0-255].0/24 address pools.
     *
     * @return self
     */
