...
class SwarmInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['node_id'] = $data['node_id'] ?? '';
        $this->container['node_addr'] = $data['node_addr'] ?? '';
        $this->container['local_node_state'] = $data['local_node_state'] ?? null;
        $this->container['control_available'] = $data['control_available'] ?? false;
        $this->container['error'] = $data['error'] ?? '';
        $this->container['remote_managers'] = $data['remote_managers'] ?? null;
