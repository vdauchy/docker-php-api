...
class Resources implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'blkio_weight' => 'int',
        'blkio_weight_device' => '\Swagger\Client\Model\ResourcesBlkioWeightDevice[]',
        'blkio_device_read_bps' => '\Swagger\Client\Model\ThrottleDevice[]',
        'blkio_device_write_bps' => '\Swagger\Client\Model\ThrottleDevice[]',
        'blkio_device_read_i_ops' => '\Swagger\Client\Model\ThrottleDevice[]',
        'blkio_device_write_i_ops' => '\Swagger\Client\Model\ThrottleDevice[]',
        'cpu_period' => 'int',
        'cpu_quota' => 'int',
        ...
        'cpuset_cpus' => 'string',
        'cpuset_mems' => 'string',
        'devices' => '\Swagger\Client\Model\DeviceMapping[]',
        ...
        'init' => 'bool',
        'pids_limit' => 'int',
        'ulimits' => '\Swagger\Client\Model\ResourcesUlimits[]',
        'cpu_count' => 'int',
        'cpu_percent' => 'int',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['disk_quota'] = isset($data['disk_quota']) ? $data['disk_quota'] : null;
     ...
     *
     * @return \Swagger\Client\Model\ResourcesBlkioWeightDevice[]
     */
     ...
     *
     * @param \Swagger\Client\Model\ResourcesBlkioWeightDevice[] $blkio_weight_device Block IO weight (relative device weight) in the form `[{\"Path\": \"device_path\", \"Weight\": weight}]`.
     *
     * @return $this
     */
     ...
     *
     * @return \Swagger\Client\Model\ThrottleDevice[]
     */
     ...
     *
     * @param \Swagger\Client\Model\ThrottleDevice[] $blkio_device_read_bps Limit read rate (bytes per second) from a device, in the form `[{\"Path\": \"device_path\", \"Rate\": rate}]`.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\ThrottleDevice[] $blkio_device_write_bps Limit write rate (bytes per second) to a device, in the form `[{\"Path\": \"device_path\", \"Rate\": rate}]`.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\ThrottleDevice[] $blkio_device_read_i_ops Limit read rate (IO per second) from a device, in the form `[{\"Path\": \"device_path\", \"Rate\": rate}]`.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\ThrottleDevice[] $blkio_device_write_i_ops Limit write rate (IO per second) to a device, in the form `[{\"Path\": \"device_path\", \"Rate\": rate}]`.
     *
     * @return $this
     */
     ...
     * Gets devices
     *
     * @return \Swagger\Client\Model\DeviceMapping[]
     */
     ...
     * Sets devices
     *
     * @param \Swagger\Client\Model\DeviceMapping[] $devices A list of devices to add to the container.
     *
     * @return $this
     */
    ...
    {
        return $this->container['disk_quota'];
    }

    /**
     * Sets disk_quota
     *
     * @param int $disk_quota Disk limit (in bytes).
     *
     * @return $this
     */
    public function setDiskQuota($disk_quota)
    {
        $this->container['disk_quota'] = $disk_quota;
     ...
     * Sets kernel_memory
     *
     * @param int $kernel_memory Kernel memory limit in bytes.
     *
     * @return $this
     */
     ...
     * Sets pids_limit
     *
     * @param int $pids_limit Tune a container's pids limit. Set -1 for unlimited.
     *
     * @return $this
     */
     ...
     * Gets ulimits
     *
     * @return \Swagger\Client\Model\ResourcesUlimits[]
     */
     ...
     * Sets ulimits
     *
     * @param \Swagger\Client\Model\ResourcesUlimits[] $ulimits A list of resource limits to set in the container. For example: `{\"Name\": \"nofile\", \"Soft\": 1024, \"Hard\": 2048}`\"
     *
     * @return $this
     */
