...
class PortBinding implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PortBinding';
     ...
     * Sets host_ip
     *
     * @param string $host_ip Host IP address that the container's port is mapped to.
     *
     * @return $this
     */
     ...
     * Sets host_port
     *
     * @param string $host_port Host port number that the container's port is mapped to.
     *
     * @return $this
     */
