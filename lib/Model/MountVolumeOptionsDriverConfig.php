...
class MountVolumeOptionsDriverConfig implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Mount_VolumeOptions_DriverConfig';
     ...
     * Sets name
     *
     * @param string $name Name of the driver to use to create the volume.
     *
     * @return $this
     */
     ...
     * Sets options
     *
     * @param map[string,string] $options key/value map of driver specific options.
     *
     * @return $this
     */
