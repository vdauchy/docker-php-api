...
class JoinTokens implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'JoinTokens';
     ...
     * Sets worker
     *
     * @param string $worker The token workers can use to join the swarm.
     *
     * @return $this
     */
     ...
     * Sets manager
     *
     * @param string $manager The token managers can use to join the swarm.
     *
     * @return $this
     */
