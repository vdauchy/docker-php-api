...
class EndpointPortConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['target_port'] = $data['target_port'] ?? null;
        $this->container['published_port'] = $data['published_port'] ?? null;
        $this->container['publish_mode'] = $data['publish_mode'] ?? 'ingress';
    }
