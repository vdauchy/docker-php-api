...
class Platform implements ModelInterface, ArrayAccess
{
     ...
     * Sets architecture
     *
     * @param string $architecture Architecture represents the hardware architecture (for example, `x86_64`).
     *
     * @return $this
     */
     ...
     * Sets os
     *
     * @param string $os OS represents the Operating System (for example, `linux` or `windows`).
     *
     * @return $this
     */
