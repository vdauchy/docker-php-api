...
class ContainerState implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['restarting'] = $data['restarting'] ?? null;
        $this->container['oom_killed'] = $data['oom_killed'] ?? null;
        $this->container['dead'] = $data['dead'] ?? null;
     ...
     * Sets oom_killed
     *
     * @param bool|null $oom_killed Whether this container has been killed because it ran out of memory.
     *
     * @return self
     */
