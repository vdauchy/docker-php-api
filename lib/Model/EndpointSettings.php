...
class EndpointSettings implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'ipam_config' => '\Swagger\Client\Model\EndpointIPAMConfig',
        'links' => 'string[]',
        'aliases' => 'string[]',
        'network_id' => 'string',
        'endpoint_id' => 'string',
    ...
    {
        $this->container['ipam_config'] = isset($data['ipam_config']) ? $data['ipam_config'] : null;
     ...
     * Gets ipam_config
     *
     * @return \Swagger\Client\Model\EndpointIPAMConfig
     */
     ...
     * Sets ipam_config
     *
     * @param \Swagger\Client\Model\EndpointIPAMConfig $ipam_config ipam_config
     *
     * @return $this
     */
     ...
     * Sets network_id
     *
     * @param string $network_id Unique ID of the network.
     *
     * @return $this
     */
     ...
     * Sets endpoint_id
     *
     * @param string $endpoint_id Unique ID for the service endpoint in a Sandbox.
     *
     * @return $this
     */
     ...
     * Sets ip_prefix_len
     *
     * @param int $ip_prefix_len Mask length of the IPv4 address.
     *
     * @return $this
     */
     ...
     * Sets i_pv6_gateway
     *
     * @param string $i_pv6_gateway IPv6 gateway address.
     *
     * @return $this
     */
     ...
     *
     * @param string $global_i_pv6_address Global IPv6 address.
     *
     * @return $this
     */
     ...
     *
     * @param int $global_i_pv6_prefix_len Mask length of the global IPv6 address.
     *
     * @return $this
     */
     ...
     * Sets mac_address
     *
     * @param string $mac_address MAC address for the endpoint on this network.
     *
     * @return $this
     */
     ...
     * Sets driver_opts
     *
     * @param map[string,string] $driver_opts DriverOpts is a mapping of driver options and values. These options are passed directly to the driver and are driver specific.
     *
     * @return $this
     */
