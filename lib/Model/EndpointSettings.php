...
class EndpointSettings implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['ipam_config'] = $data['ipam_config'] ?? null;
        ...
        $this->container['driver_opts'] = $data['driver_opts'] ?? null;
    }
     ...
     * Sets mac_address
     *
     * @param string|null $mac_address MAC address for the endpoint on this network.
     *
     * @return self
     */
