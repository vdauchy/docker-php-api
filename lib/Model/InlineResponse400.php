...
class InlineResponse400 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'error_response' => '\Swagger\Client\Model\ErrorResponse',
        'message' => 'string'
    ];
     ...
     * Sets error_response
     *
     * @param \Swagger\Client\Model\ErrorResponse $error_response error_response
     *
     * @return $this
     */
     ...
     * Sets message
     *
     * @param string $message The error message. Either \"must specify path parameter\" (path cannot be empty) or \"not a directory\" (path was asserted to be a directory but exists as a file).
     *
     * @return $this
     */
