...
class NetworkingConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['endpoints_config'] = $data['endpoints_config'] ?? null;
    }
     ...
     *
     * @param array<string,\OpenAPI\Client\Model\EndpointSettings>|null $endpoints_config A mapping of network name to endpoint configuration for that network.
     *
     * @return self
     */
