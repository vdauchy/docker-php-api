...
class ServiceApi
{
     ...
     * @param  string $x_registry_auth A base64-encoded auth configuration for pulling from private registries. [See the authentication section for details.](#section/Authentication) (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ServiceCreateResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ServiceCreateResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function serviceCreateWithHttpInfo($body, $x_registry_auth = null)
    {
        $returnType = '\Swagger\Client\Model\ServiceCreateResponse';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ServiceCreateResponse',
    ...
    protected function serviceInspectRequest($id, $insert_defaults = 'false')
    {
        ...
        if ($insert_defaults !== null) {
            $queryParams['insertDefaults'] = ObjectSerializer::toQueryValue($insert_defaults);
        }
     ...
     * @param  string $id ID or name of service. (required)
     * @param  object $body body (required)
     * @param  int $version The version number of the service object being updated. This is required to avoid conflicting writes. (required)
     * @param  string $registry_auth_from If the X-Registry-Auth header is not specified, this parameter indicates where to find registry authorization credentials. The valid values are &#x60;spec&#x60; and &#x60;previous-spec&#x60;. (optional, default to spec)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ServiceUpdateResponse
     */
    public function serviceUpdate($id, $body, $version, $registry_auth_from = 'spec', $rollback = null, $x_registry_auth = null)
    {
        list($response) = $this->serviceUpdateWithHttpInfo($id, $body, $version, $registry_auth_from, $rollback, $x_registry_auth);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ServiceUpdateResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function serviceUpdateWithHttpInfo($id, $body, $version, $registry_auth_from = 'spec', $rollback = null, $x_registry_auth = null)
    {
        $returnType = '\Swagger\Client\Model\ServiceUpdateResponse';
        $request = $this->serviceUpdateRequest($id, $body, $version, $registry_auth_from, $rollback, $x_registry_auth);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ServiceUpdateResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function serviceUpdateAsync($id, $body, $version, $registry_auth_from = 'spec', $rollback = null, $x_registry_auth = null)
    {
        return $this->serviceUpdateAsyncWithHttpInfo($id, $body, $version, $registry_auth_from, $rollback, $x_registry_auth)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function serviceUpdateAsyncWithHttpInfo($id, $body, $version, $registry_auth_from = 'spec', $rollback = null, $x_registry_auth = null)
    {
        $returnType = '\Swagger\Client\Model\ServiceUpdateResponse';
        $request = $this->serviceUpdateRequest($id, $body, $version, $registry_auth_from, $rollback, $x_registry_auth);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function serviceUpdateRequest($id, $body, $version, $registry_auth_from = 'spec', $rollback = null, $x_registry_auth = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($registry_auth_from !== null) {
            $queryParams['registryAuthFrom'] = ObjectSerializer::toQueryValue($registry_auth_from);
        }
        // query params
        if ($rollback !== null) {
