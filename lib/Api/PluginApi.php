...
class PluginApi
{
     ...
     * @return \Swagger\Client\Model\PluginPrivilegeItem[]
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\PluginPrivilegeItem[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getPluginPrivilegesWithHttpInfo($remote)
    {
        $returnType = '\Swagger\Client\Model\PluginPrivilegeItem[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\PluginPrivilegeItem[]',
     ...
     * @param  string $tar_context Path to tar containing plugin rootfs and manifest (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function pluginCreateRequest($name, $tar_context = null)
    {
     ...
     * @param  string $x_registry_auth A base64-encoded auth configuration to use when pulling a plugin from a registry. [See the authentication section for details.](#section/Authentication) (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function pluginPullRequest($remote, $name = null, $x_registry_auth = null, $body = null)
    {
        // verify the required parameter 'remote' is set
        if ($remote === null || (is_array($remote) && count($remote) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function pluginUpgradeRequest($name, $remote, $x_registry_auth = null, $body = null)
    {
        // verify the required parameter 'name' is set
        if ($name === null || (is_array($name) && count($name) === 0)) {
            throw new \InvalidArgumentException(
