...
class ContainerApi
{
    ...
    protected function containerAttachRequest($id, $detach_keys = null, $logs = 'false', $stream = 'false', $stdin = 'false', $stdout = 'false', $stderr = 'false')
    {
        ...
        // query params
        if ($detach_keys !== null) {
            $queryParams['detachKeys'] = ObjectSerializer::toQueryValue($detach_keys);
        }
        // query params
        if ($logs !== null) {
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ContainerChangeResponseItem[]
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ContainerChangeResponseItem[], HTTP status code, HTTP response headers (array of strings)
     */
    public function containerChangesWithHttpInfo($id)
    {
        $returnType = '\Swagger\Client\Model\ContainerChangeResponseItem[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ContainerChangeResponseItem[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ContainerCreateResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ContainerCreateResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function containerCreateWithHttpInfo($body, $name = null)
    {
        $returnType = '\Swagger\Client\Model\ContainerCreateResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ContainerCreateResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ContainerInspectResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ContainerInspectResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function containerInspectWithHttpInfo($id, $size = 'false')
    {
        $returnType = '\Swagger\Client\Model\ContainerInspectResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ContainerInspectResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ContainerSummary, HTTP status code, HTTP response headers (array of strings)
     */
    public function containerListWithHttpInfo($all = 'false', $limit = null, $size = 'false', $filters = null)
    {
        $returnType = '\Swagger\Client\Model\ContainerSummary';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ContainerSummary',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ContainerPruneResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ContainerPruneResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function containerPruneWithHttpInfo($filters = null)
    {
        $returnType = '\Swagger\Client\Model\ContainerPruneResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ContainerPruneResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    protected function containerStatsRequest($id, $stream = 'true', $one_shot = 'false')
    {
        ...
        // query params
        if ($one_shot !== null) {
            $queryParams['one-shot'] = ObjectSerializer::toQueryValue($one_shot);
        }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ContainerTopResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ContainerTopResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function containerTopWithHttpInfo($id, $ps_args = '-ef')
    {
        $returnType = '\Swagger\Client\Model\ContainerTopResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ContainerTopResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    protected function containerTopRequest($id, $ps_args = '-ef')
    {
        ...
        // query params
        if ($ps_args !== null) {
            $queryParams['ps_args'] = ObjectSerializer::toQueryValue($ps_args);
        }
     ...
     *
     * @param  string $id ID or name of the container (required)
     * @param  object $update update (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ContainerUpdateResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ContainerUpdateResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function containerUpdateWithHttpInfo($id, $update)
    {
        $returnType = '\Swagger\Client\Model\ContainerUpdateResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ContainerUpdateResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ContainerWaitResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ContainerWaitResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function containerWaitWithHttpInfo($id, $condition = 'not-running')
    {
        $returnType = '\Swagger\Client\Model\ContainerWaitResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ContainerWaitResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $input_stream The input stream must be a tar archive compressed with one of the following algorithms: &#x60;identity&#x60; (no compression), &#x60;gzip&#x60;, &#x60;bzip2&#x60;, or &#x60;xz&#x60;. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function putContainerArchiveRequest($id, $path, $input_stream, $no_overwrite_dir_non_dir = null, $copy_uidgid = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($no_overwrite_dir_non_dir !== null) {
            $queryParams['noOverwriteDirNonDir'] = ObjectSerializer::toQueryValue($no_overwrite_dir_non_dir);
        }
        // query params
        if ($copy_uidgid !== null) {
            $queryParams['copyUIDGID'] = ObjectSerializer::toQueryValue($copy_uidgid);
        }
