...
class VolumeApi
{
     ...
     * Create a volume
     *
     * @param  \Swagger\Client\Model\VolumeConfig $volume_config Volume configuration (required)
     *
    ...
    {
        $returnType = '\Swagger\Client\Model\Volume';
     ...
     */
    protected function volumeCreateRequest($volume_config)
    {
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\VolumeListResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\VolumeListResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function volumeListWithHttpInfo($filters = null)
    {
        $returnType = '\Swagger\Client\Model\VolumeListResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\VolumeListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\VolumePruneResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\VolumePruneResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function volumePruneWithHttpInfo($filters = null)
    {
        $returnType = '\Swagger\Client\Model\VolumePruneResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\VolumePruneResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
