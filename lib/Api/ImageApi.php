...
class ImageApi
{
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\BuildPruneResponse',
     ...
     * Build an image
     *
     * @param  string $input_stream A tar archive compressed with one of the following algorithms: identity (no compression), gzip, bzip2, xz. (optional)
     ...
     *
     * @param  \Swagger\Client\Model\ContainerConfig $container_config The container configuration (optional)
     ...
     */
    public function imageCommit($container_config = null, $container = null, $repo = null, $tag = null, $comment = null, $author = null, $pause = 'true', $changes = null)
    {
        list($response) = $this->imageCommitWithHttpInfo($container_config, $container, $repo, $tag, $comment, $author, $pause, $changes);
        return $response;
    }
     ...
     */
    public function imageCommitWithHttpInfo($container_config = null, $container = null, $repo = null, $tag = null, $comment = null, $author = null, $pause = 'true', $changes = null)
    {
        $returnType = '\Swagger\Client\Model\IdResponse';
        $request = $this->imageCommitRequest($container_config, $container, $repo, $tag, $comment, $author, $pause, $changes);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function imageCommitAsync($container_config = null, $container = null, $repo = null, $tag = null, $comment = null, $author = null, $pause = 'true', $changes = null)
    {
        return $this->imageCommitAsyncWithHttpInfo($container_config, $container, $repo, $tag, $comment, $author, $pause, $changes)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function imageCommitAsyncWithHttpInfo($container_config = null, $container = null, $repo = null, $tag = null, $comment = null, $author = null, $pause = 'true', $changes = null)
    {
        $returnType = '\Swagger\Client\Model\IdResponse';
        $request = $this->imageCommitRequest($container_config, $container, $repo, $tag, $comment, $author, $pause, $changes);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function imageCommitRequest($container_config = null, $container = null, $repo = null, $tag = null, $comment = null, $author = null, $pause = 'true', $changes = null)
    {
    ...
    protected function imageCreateRequest($from_image = null, $from_src = null, $repo = null, $tag = null, $message = null, $input_image = null, $x_registry_auth = null, $platform = '')
    {
        ...
        // query params
        if ($from_image !== null) {
            $queryParams['fromImage'] = ObjectSerializer::toQueryValue($from_image);
        }
        // query params
        if ($from_src !== null) {
            $queryParams['fromSrc'] = ObjectSerializer::toQueryValue($from_src);
        }
        // query params
        if ($repo !== null) {
            $queryParams['repo'] = ObjectSerializer::toQueryValue($repo);
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ImageDeleteResponseItem[]
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ImageDeleteResponseItem[], HTTP status code, HTTP response headers (array of strings)
     */
    public function imageDeleteWithHttpInfo($name, $force = 'false', $noprune = 'false')
    {
        $returnType = '\Swagger\Client\Model\ImageDeleteResponseItem[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ImageDeleteResponseItem[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\HistoryResponseItem[]
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\HistoryResponseItem[], HTTP status code, HTTP response headers (array of strings)
     */
    public function imageHistoryWithHttpInfo($name)
    {
        $returnType = '\Swagger\Client\Model\HistoryResponseItem[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\HistoryResponseItem[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ImageSummary[], HTTP status code, HTTP response headers (array of strings)
     */
    public function imageListWithHttpInfo($all = 'false', $filters = null, $digests = 'false')
    {
        $returnType = '\Swagger\Client\Model\ImageSummary[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ImageSummary[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * Import images
     *
     * @param  string $images_tarball Tar archive containing images (optional)
     ...
     * @return void
     */
    public function imageLoad($images_tarball = null, $quiet = 'false')
    {
        $this->imageLoadWithHttpInfo($images_tarball, $quiet);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function imageLoadWithHttpInfo($images_tarball = null, $quiet = 'false')
    {
        $returnType = '';
        $request = $this->imageLoadRequest($images_tarball, $quiet);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function imageLoadAsync($images_tarball = null, $quiet = 'false')
    {
        return $this->imageLoadAsyncWithHttpInfo($images_tarball, $quiet)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function imageLoadAsyncWithHttpInfo($images_tarball = null, $quiet = 'false')
    {
        $returnType = '';
        $request = $this->imageLoadRequest($images_tarball, $quiet);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function imageLoadRequest($images_tarball = null, $quiet = 'false')
    {
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ImagePruneResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ImagePruneResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function imagePruneWithHttpInfo($filters = null)
    {
        $returnType = '\Swagger\Client\Model\ImagePruneResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ImagePruneResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ImageSearchResponseItem[]
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ImageSearchResponseItem[], HTTP status code, HTTP response headers (array of strings)
     */
    public function imageSearchWithHttpInfo($term, $limit = null, $filters = null)
    {
        $returnType = '\Swagger\Client\Model\ImageSearchResponseItem[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ImageSearchResponseItem[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
