...
class ImageApi
{
     ...
     */
    public function buildPruneRequest($keep_storage = null, $all = null, $filters = null)
    {
        ...
        // query params
        if (is_array($keep_storage)) {
            $keep_storage = ObjectSerializer::serializeCollection($keep_storage, '', true);
        }
        if ($keep_storage !== null) {
            $queryParams['keep-storage'] = $keep_storage;
        }
        // query params
        if (is_array($all)) {
     ...
     * @return void
     */
    public function imageBuild($dockerfile = 'Dockerfile', $t = null, $extrahosts = null, $remote = null, $q = false, $nocache = false, $cachefrom = null, $pull = null, $rm = true, $forcerm = false, $memory = null, $memswap = null, $cpushares = null, $cpusetcpus = null, $cpuperiod = null, $cpuquota = null, $buildargs = null, $shmsize = null, $squash = null, $labels = null, $networkmode = null, $content_type = 'application/x-tar', $x_registry_config = null, $platform = null, $target = null, $outputs = null, $input_stream = null)
    {
        $this->imageBuildWithHttpInfo($dockerfile, $t, $extrahosts, $remote, $q, $nocache, $cachefrom, $pull, $rm, $forcerm, $memory, $memswap, $cpushares, $cpusetcpus, $cpuperiod, $cpuquota, $buildargs, $shmsize, $squash, $labels, $networkmode, $content_type, $x_registry_config, $platform, $target, $outputs, $input_stream);
    }
    ...
    {
        $request = $this->imageBuildRequest($dockerfile, $t, $extrahosts, $remote, $q, $nocache, $cachefrom, $pull, $rm, $forcerm, $memory, $memswap, $cpushares, $cpusetcpus, $cpuperiod, $cpuquota, $buildargs, $shmsize, $squash, $labels, $networkmode, $content_type, $x_registry_config, $platform, $target, $outputs, $input_stream);
    ...
    {
        return $this->imageBuildAsyncWithHttpInfo($dockerfile, $t, $extrahosts, $remote, $q, $nocache, $cachefrom, $pull, $rm, $forcerm, $memory, $memswap, $cpushares, $cpusetcpus, $cpuperiod, $cpuquota, $buildargs, $shmsize, $squash, $labels, $networkmode, $content_type, $x_registry_config, $platform, $target, $outputs, $input_stream)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    public function imageBuildRequest($dockerfile = 'Dockerfile', $t = null, $extrahosts = null, $remote = null, $q = false, $nocache = false, $cachefrom = null, $pull = null, $rm = true, $forcerm = false, $memory = null, $memswap = null, $cpushares = null, $cpusetcpus = null, $cpuperiod = null, $cpuquota = null, $buildargs = null, $shmsize = null, $squash = null, $labels = null, $networkmode = null, $content_type = 'application/x-tar', $x_registry_config = null, $platform = null, $target = null, $outputs = null, $input_stream = null)
    {
        ...
        // query params
        if (is_array($dockerfile)) {
            $dockerfile = ObjectSerializer::serializeCollection($dockerfile, '', true);
        }
        if ($dockerfile !== null) {
            $queryParams['dockerfile'] = $dockerfile;
        }
        // query params
        if (is_array($t)) {
            $t = ObjectSerializer::serializeCollection($t, '', true);
        }
        if ($t !== null) {
            $queryParams['t'] = $t;
        }
        ...
        if (is_array($extrahosts)) {
            $extrahosts = ObjectSerializer::serializeCollection($extrahosts, '', true);
        }
        if ($extrahosts !== null) {
            $queryParams['extrahosts'] = $extrahosts;
        }
        // query params
        if (is_array($remote)) {
        ...
        // query params
        if (is_array($nocache)) {
            $nocache = ObjectSerializer::serializeCollection($nocache, '', true);
        }
        if ($nocache !== null) {
            $queryParams['nocache'] = $nocache;
        }
        // query params
        if (is_array($cachefrom)) {
            $cachefrom = ObjectSerializer::serializeCollection($cachefrom, '', true);
        }
        if ($cachefrom !== null) {
            $queryParams['cachefrom'] = $cachefrom;
        }
        // query params
        if (is_array($pull)) {
            $pull = ObjectSerializer::serializeCollection($pull, '', true);
        }
        if ($pull !== null) {
            $queryParams['pull'] = $pull;
        }
        // query params
        if (is_array($rm)) {
            $rm = ObjectSerializer::serializeCollection($rm, '', true);
        }
        if ($rm !== null) {
            $queryParams['rm'] = $rm;
        }
        // query params
        if (is_array($forcerm)) {
            $forcerm = ObjectSerializer::serializeCollection($forcerm, '', true);
        }
        if ($forcerm !== null) {
            $queryParams['forcerm'] = $forcerm;
        }
        // query params
        if (is_array($memory)) {
            $memory = ObjectSerializer::serializeCollection($memory, '', true);
        }
        if ($memory !== null) {
            $queryParams['memory'] = $memory;
        }
        // query params
        if (is_array($memswap)) {
            $memswap = ObjectSerializer::serializeCollection($memswap, '', true);
        }
        if ($memswap !== null) {
            $queryParams['memswap'] = $memswap;
        }
        // query params
        if (is_array($cpushares)) {
            $cpushares = ObjectSerializer::serializeCollection($cpushares, '', true);
        }
        if ($cpushares !== null) {
            $queryParams['cpushares'] = $cpushares;
        }
        // query params
        if (is_array($cpusetcpus)) {
            $cpusetcpus = ObjectSerializer::serializeCollection($cpusetcpus, '', true);
        }
        if ($cpusetcpus !== null) {
            $queryParams['cpusetcpus'] = $cpusetcpus;
        }
        // query params
        if (is_array($cpuperiod)) {
            $cpuperiod = ObjectSerializer::serializeCollection($cpuperiod, '', true);
        }
        if ($cpuperiod !== null) {
            $queryParams['cpuperiod'] = $cpuperiod;
        }
        // query params
        if (is_array($cpuquota)) {
            $cpuquota = ObjectSerializer::serializeCollection($cpuquota, '', true);
        }
        if ($cpuquota !== null) {
            $queryParams['cpuquota'] = $cpuquota;
        }
        // query params
        if (is_array($buildargs)) {
            $buildargs = ObjectSerializer::serializeCollection($buildargs, '', true);
        }
        if ($buildargs !== null) {
            $queryParams['buildargs'] = $buildargs;
        }
        // query params
        if (is_array($shmsize)) {
            $shmsize = ObjectSerializer::serializeCollection($shmsize, '', true);
        }
        if ($shmsize !== null) {
            $queryParams['shmsize'] = $shmsize;
        }
        // query params
        if (is_array($squash)) {
            $squash = ObjectSerializer::serializeCollection($squash, '', true);
        }
        if ($squash !== null) {
            $queryParams['squash'] = $squash;
        }
        // query params
        if (is_array($labels)) {
        ...
        // query params
        if (is_array($networkmode)) {
            $networkmode = ObjectSerializer::serializeCollection($networkmode, '', true);
        }
        if ($networkmode !== null) {
        ...
        // query params
        if (is_array($target)) {
            $target = ObjectSerializer::serializeCollection($target, '', true);
        }
        if ($target !== null) {
        ...
        // query params
        if (is_array($outputs)) {
            $outputs = ObjectSerializer::serializeCollection($outputs, '', true);
        }
        if ($outputs !== null) {
        ...
        if (isset($input_stream)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($input_stream));
            } else {
     ...
     */
    public function imageCommit($container = null, $repo = null, $tag = null, $comment = null, $author = null, $pause = true, $changes = null, $container_config = null)
    {
        list($response) = $this->imageCommitWithHttpInfo($container, $repo, $tag, $comment, $author, $pause, $changes, $container_config);
        return $response;
    }
     ...
     */
    public function imageCommitWithHttpInfo($container = null, $repo = null, $tag = null, $comment = null, $author = null, $pause = true, $changes = null, $container_config = null)
    {
        $request = $this->imageCommitRequest($container, $repo, $tag, $comment, $author, $pause, $changes, $container_config);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function imageCommitAsync($container = null, $repo = null, $tag = null, $comment = null, $author = null, $pause = true, $changes = null, $container_config = null)
    {
        return $this->imageCommitAsyncWithHttpInfo($container, $repo, $tag, $comment, $author, $pause, $changes, $container_config)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function imageCommitAsyncWithHttpInfo($container = null, $repo = null, $tag = null, $comment = null, $author = null, $pause = true, $changes = null, $container_config = null)
    {
        $returnType = '\OpenAPI\Client\Model\IdResponse';
        $request = $this->imageCommitRequest($container, $repo, $tag, $comment, $author, $pause, $changes, $container_config);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function imageCommitRequest($container = null, $repo = null, $tag = null, $comment = null, $author = null, $pause = true, $changes = null, $container_config = null)
    {
        ...
        if (is_array($container)) {
            $container = ObjectSerializer::serializeCollection($container, '', true);
        }
        if ($container !== null) {
        ...
        // query params
        if (is_array($repo)) {
            $repo = ObjectSerializer::serializeCollection($repo, '', true);
        }
        if ($repo !== null) {
        ...
        // query params
        if (is_array($pause)) {
            $pause = ObjectSerializer::serializeCollection($pause, '', true);
        }
        if ($pause !== null) {
            $queryParams['pause'] = $pause;
        }
        // query params
        if (is_array($changes)) {
            $changes = ObjectSerializer::serializeCollection($changes, '', true);
        }
        if ($changes !== null) {
            $queryParams['changes'] = $changes;
        }
        ...
        if (isset($container_config)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($container_config));
            } else {
     ...
     * @return void
     */
    public function imageCreate($from_image = null, $from_src = null, $repo = null, $tag = null, $message = null, $x_registry_auth = null, $platform = null, $input_image = null)
    {
        $this->imageCreateWithHttpInfo($from_image, $from_src, $repo, $tag, $message, $x_registry_auth, $platform, $input_image);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function imageCreateWithHttpInfo($from_image = null, $from_src = null, $repo = null, $tag = null, $message = null, $x_registry_auth = null, $platform = null, $input_image = null)
    {
        $request = $this->imageCreateRequest($from_image, $from_src, $repo, $tag, $message, $x_registry_auth, $platform, $input_image);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function imageCreateAsync($from_image = null, $from_src = null, $repo = null, $tag = null, $message = null, $x_registry_auth = null, $platform = null, $input_image = null)
    {
        return $this->imageCreateAsyncWithHttpInfo($from_image, $from_src, $repo, $tag, $message, $x_registry_auth, $platform, $input_image)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function imageCreateAsyncWithHttpInfo($from_image = null, $from_src = null, $repo = null, $tag = null, $message = null, $x_registry_auth = null, $platform = null, $input_image = null)
    {
        $returnType = '';
        $request = $this->imageCreateRequest($from_image, $from_src, $repo, $tag, $message, $x_registry_auth, $platform, $input_image);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function imageCreateRequest($from_image = null, $from_src = null, $repo = null, $tag = null, $message = null, $x_registry_auth = null, $platform = null, $input_image = null)
    {
        ...
        if (is_array($from_image)) {
            $from_image = ObjectSerializer::serializeCollection($from_image, '', true);
        }
        if ($from_image !== null) {
            $queryParams['fromImage'] = $from_image;
        }
        // query params
        if (is_array($from_src)) {
            $from_src = ObjectSerializer::serializeCollection($from_src, '', true);
        }
        if ($from_src !== null) {
            $queryParams['fromSrc'] = $from_src;
        }
        // query params
        if (is_array($repo)) {
            $repo = ObjectSerializer::serializeCollection($repo, '', true);
        ...
        if (isset($input_image)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($input_image));
            } else {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function imageDeleteRequest($name, $force = false, $noprune = false)
    {
        ...
        // query params
        if (is_array($noprune)) {
            $noprune = ObjectSerializer::serializeCollection($noprune, '', true);
        }
        if ($noprune !== null) {
            $queryParams['noprune'] = $noprune;
        }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function imageGetRequest($name)
    {
        // verify the required parameter 'name' is set
        if ($name === null || (is_array($name) && count($name) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function imageGetAllRequest($names = null)
    {
        ...
        // query params
        if (is_array($names)) {
            $names = ObjectSerializer::serializeCollection($names, 'form', true);
        }
        if ($names !== null) {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function imageHistoryRequest($name)
    {
        // verify the required parameter 'name' is set
        if ($name === null || (is_array($name) && count($name) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\Image|\OpenAPI\Client\Model\ErrorResponse|\OpenAPI\Client\Model\ErrorResponse
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\Image|\OpenAPI\Client\Model\ErrorResponse|\OpenAPI\Client\Model\ErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function imageInspectRequest($name)
    {
        // verify the required parameter 'name' is set
        if ($name === null || (is_array($name) && count($name) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function imageListRequest($all = false, $filters = null, $digests = false)
    {
        ...
        // query params
        if (is_array($digests)) {
            $digests = ObjectSerializer::serializeCollection($digests, '', true);
        }
        if ($digests !== null) {
            $queryParams['digests'] = $digests;
        }
     ...
     * @return void
     */
    public function imageLoad($quiet = false, $images_tarball = null)
    {
        $this->imageLoadWithHttpInfo($quiet, $images_tarball);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function imageLoadWithHttpInfo($quiet = false, $images_tarball = null)
    {
        $request = $this->imageLoadRequest($quiet, $images_tarball);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function imageLoadAsync($quiet = false, $images_tarball = null)
    {
        return $this->imageLoadAsyncWithHttpInfo($quiet, $images_tarball)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function imageLoadAsyncWithHttpInfo($quiet = false, $images_tarball = null)
    {
        $returnType = '';
        $request = $this->imageLoadRequest($quiet, $images_tarball);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function imageLoadRequest($quiet = false, $images_tarball = null)
    {
        ...
        // query params
        if (is_array($quiet)) {
            $quiet = ObjectSerializer::serializeCollection($quiet, '', true);
        }
        if ($quiet !== null) {
            $queryParams['quiet'] = $quiet;
        }
        ...
        if (isset($images_tarball)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($images_tarball));
            } else {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function imagePruneRequest($filters = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function imagePushRequest($name, $x_registry_auth, $tag = null)
    {
        // verify the required parameter 'name' is set
        if ($name === null || (is_array($name) && count($name) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function imageSearchRequest($term, $limit = null, $filters = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function imageTagRequest($name, $repo = null, $tag = null)
    {
        // verify the required parameter 'name' is set
        if ($name === null || (is_array($name) && count($name) === 0)) {
            throw new \InvalidArgumentException(
