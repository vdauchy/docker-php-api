...
[**\Swagger\Client\Model\BuildPruneResponse**](../Model/BuildPruneResponse.md)
...
$input_stream = "B"; // string | A tar archive compressed with one of the following algorithms: identity (no compression), gzip, bzip2, xz.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **input_stream** | **string**| A tar archive compressed with one of the following algorithms: identity (no compression), gzip, bzip2, xz. | [optional]
...
# **imageCommit**
> \Swagger\Client\Model\IdResponse imageCommit($container_config, $container, $repo, $tag, $comment, $author, $pause, $changes)
...
$container_config = new \Swagger\Client\Model\ContainerConfig(); // \Swagger\Client\Model\ContainerConfig | The container configuration
...
try {
    $result = $apiInstance->imageCommit($container_config, $container, $repo, $tag, $comment, $author, $pause, $changes);
    print_r($result);
} catch (Exception $e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **container_config** | [**\Swagger\Client\Model\ContainerConfig**](../Model/ContainerConfig.md)| The container configuration | [optional]
...
# **imageDelete**
> \Swagger\Client\Model\ImageDeleteResponseItem[] imageDelete($name, $force, $noprune)
...
[**\Swagger\Client\Model\ImageDeleteResponseItem[]**](../Model/ImageDeleteResponseItem.md)
...
# **imageHistory**
> \Swagger\Client\Model\HistoryResponseItem[] imageHistory($name)
...
[**\Swagger\Client\Model\HistoryResponseItem[]**](../Model/HistoryResponseItem.md)
...
# **imageInspect**
> \Swagger\Client\Model\Image imageInspect($name)
...
# **imageList**
> \Swagger\Client\Model\ImageSummary[] imageList($all, $filters, $digests)
...
[**\Swagger\Client\Model\ImageSummary[]**](../Model/ImageSummary.md)
...
# **imageLoad**
> imageLoad($images_tarball, $quiet)
...
$images_tarball = "B"; // string | Tar archive containing images
$quiet = false; // bool | Suppress progress details during load.

try {
    $apiInstance->imageLoad($images_tarball, $quiet);
} catch (Exception $e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **images_tarball** | **string**| Tar archive containing images | [optional]
...
# **imagePrune**
> \Swagger\Client\Model\ImagePruneResponse imagePrune($filters)
...
[**\Swagger\Client\Model\ImagePruneResponse**](../Model/ImagePruneResponse.md)
...
# **imageSearch**
> \Swagger\Client\Model\ImageSearchResponseItem[] imageSearch($term, $limit, $filters)
...
[**\Swagger\Client\Model\ImageSearchResponseItem[]**](../Model/ImageSearchResponseItem.md)
