...
# **configCreate**
> \Swagger\Client\Model\IdResponse configCreate($body)
...
# **configInspect**
> \Swagger\Client\Model\Config configInspect($id)
...
# **configList**
> \Swagger\Client\Model\Config[] configList($filters)
...
$body = new \Swagger\Client\Model\ConfigSpec(); // \Swagger\Client\Model\ConfigSpec | The spec of the config to update. Currently, only the Labels field can be updated. All other fields must remain unchanged from the [ConfigInspect endpoint](#operation/ConfigInspect) response values.
 ...
 **body** | [**\Swagger\Client\Model\ConfigSpec**](../Model/ConfigSpec.md)| The spec of the config to update. Currently, only the Labels field can be updated. All other fields must remain unchanged from the [ConfigInspect endpoint](#operation/ConfigInspect) response values. | [optional]
